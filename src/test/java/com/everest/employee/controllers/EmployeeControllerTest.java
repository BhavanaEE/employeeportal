...
class EmployeeControllerTest {
    ...
    @Test
    void shouldFetchEmployeeByFirstName() throws Exception {
        String searchKeyword = "Bhavana";
        Page<Employee> employeePage = new PageImpl<>(this.employees);
        when(employeeService.getEmployeeByName(eq(searchKeyword), any(Pageable.class))).thenReturn(employeePage);
